...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { description: @option.description, name: @option.name, price: @option.price, question_id: @option.question_id }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { description: @option.description, name: @option.name, price: @option.price, question_id: @option.question_id }
    assert_redirected_to option_path(assigns(:option))
  end
