...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { description: @food_item.description, price: @food_item.price, vendor_id: @food_item.vendor_id }
    end
  ...
  test "should update food_item" do
    patch :update, id: @food_item, food_item: { description: @food_item.description, price: @food_item.price, vendor_id: @food_item.vendor_id }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
